  ...
  return <section className="detail-page">
    ...
    <div className="detail-content section">
      ...
      <aside className="detail-sidebar">
        {item.poster_url && <a className="detail-poster" href={item.poster_source_url || item.poster_url} target="_blank" rel="noreferrer"><img src={item.poster_url} alt={`${item.artist_name} 공연 포스터`} /><span>공식 포스터 출처 ↗</span></a>}
